...
export class AnthropometricsService {
  ...
  saveAnthropometrics(data: Anthropometrics): Observable<Anthropometrics> {
    return this.http.post<Anthropometrics>('http://localhost:8081/api/ergonomic/new', data);
  }
  ...
  getPdf(email: string): Observable<Blob> {
    ...
    return this.http.get<Blob>('http://localhost:8081/api/ergonomic/openPdf/' + email, { headers: headers, responseType: 'blob' as 'json' });
  }
  ...
  getPdfAfterAuth(): Observable<any> {
    ...
    return this.http.get("http://localhost:8081/api/ergonomic/auth/pdf", { headers: headers, responseType: 'blob' });
  } 
